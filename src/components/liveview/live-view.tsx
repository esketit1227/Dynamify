...
import { buildLibraryFromElements } from "@/lib/sites/library";
import { elementTypeLabel } from "@/lib/format/labels";
...
export function LiveView({
  ...
  // Same "approved asset library" principle as src/lib/sites/library.ts's
  // other callers — real alternative content already found on the site,
  ...
  const library = useMemo(() => buildLibraryFromElements(elements), [elements]);
