    ...
    <section id="pricing" className="px-6 pb-20 md:pb-[130px]">
      <div className="mx-auto max-w-[1180px]">
        ...
        <div className="mt-8 flex justify-center">
          <div className="inline-flex items-center gap-1 rounded-full bg-[#efeef2] p-1">
            <button
              type="button"
              onClick={() => setAnnual(false)}
              aria-pressed={!annual}
              className={`rounded-full px-5 py-2 text-sm font-bold tracking-[-.01em] transition-colors ${
                !annual ? "bg-[#111014] text-[#fdfdfe]" : "text-[#56545e] hover:text-[#111014]"
              }`}
            >
              Monthly
            </button>
            ...
            >
              ...
              <span
                className={`rounded-full px-2 py-0.5 text-[11px] ${
                  annual ? "bg-[#fdfdfe]/15 text-[#fdfdfe]" : "bg-[#111014]/8 text-[#56545e]"
                }`}
              >
                2 months free
              </span>
          ...
          {TIERS.map((tier) => {
            ...
            return (
              ...
              >
                ...
                <p className={`mt-1 text-[13px] ${tier.highlight ? "text-[#8e8c97]" : "text-[#7c7a85]"}`}>
                  {tier.monthly !== null
                    ? annual
                ...
                <p className={`mt-2 text-[15px] leading-[1.4] tracking-[-.018em] ${tier.highlight ? "text-[#dad9e0]" : "text-[#56545e]"}`}>
                  {tier.tagline}
                </p>
